...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.footsteps = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("Footstep Sounds", "Array of footstep sounds to be randomly played while walking."), fpc.footsteps, typeof(AudioClip), true);
        fpc.audioSource = (AudioSource)EditorGUILayout.ObjectField(new GUIContent("Audio Source", "Audio source to play footstep sounds through."), fpc.audioSource, typeof(AudioSource), true);
